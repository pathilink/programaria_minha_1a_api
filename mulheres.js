...
const cors = require('cors') // trazendo o pacote cors para consumir api no front end
const conectaBancoDeDados = require('./bancoDeDados') // ligando ao arquivo bancoDeDados.js
